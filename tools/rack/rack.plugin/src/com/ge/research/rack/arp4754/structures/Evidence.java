 ...
 * @author Saswata Paul
 * 
 * This is a class that will be used to represent any type of evidence inside RACK
 * 
 * NOTE:Using a single class called EVIDENCE instead of REQUIreMENTS, ANALYSIS, etc will allow us to have a smaller kernel and more generic code/ algorithms
 *
 */
public class Evidence {
	 ...
	 * 1. These properties are not the exact properties from the RACK ontology, but properties that are relevant to ARP4754 verbiage to keep the kernel simple
	 * 2. There are few main properties: allocatedTo, mitigates, tracesUp, tracesDown, hasReviews, hasTests, hasVerifications, hasValidations, result, 
	 * 
    ...
    private List<Evidence> hasResult = new ArrayList<Evidence>(); // for tests, verifications, and review logs
