...
public class ConnectionUtil {
    ...
    public static boolean ping() {
        ...
        try {
            ...
            System.out.println("RACK Services down, please check your Rack-Box instance");
            return false;
        } catch (Exception e) {
            
        	 System.out.println("Unable to configure connection to check RACK service availability");
            return false;
        }
    }
    ...
    public static SparqlConnection getSparqlConnection(
        ...
        for (int i = 0; i < dataGraphs.size(); i++) {
            ...
            try {
                ...
                System.out.println("Cannot add extra data graph: " + dataGraphs.get(i));
            }
        }
